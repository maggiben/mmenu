...
static void OnNameEditChange(HWND hDlg);
...
void OnInit(HWND hDlg)
{
	...
	SendDlgItemMessage(hDlg, IDC_TIMERSPIN1, UDM_SETRANGE, 0,
		(1440 << 16) + 0);
	SendDlgItemMessage(hDlg, IDC_TIMERSPIN1, UDM_SETBUDDY,
		(WPARAM)GetDlgItem(hDlg, IDC_TIMERMINUTE), 0);
	SendDlgItemMessage(hDlg, IDC_TIMERSPIN2, UDM_SETRANGE, 0,
		(59 << 16) + 0);
	SendDlgItemMessage(hDlg, IDC_TIMERSPIN2, UDM_SETBUDDY,
		(WPARAM)GetDlgItem(hDlg, IDC_TIMERSECOND), 0);
...
/*------------------------------------------------
   Name" text is changed
--------------------------------------------------*/
void OnNameEditChange(HWND hDlg)
{

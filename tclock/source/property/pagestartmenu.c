...
void OnInit(HWND hDlg)
{
	...
	SendDlgItemMessage(hDlg, IDC_STARTMENUTRANSSPIN, UDM_SETBUDDY,
		(WPARAM)GetDlgItem(hDlg, IDC_STARTMENUTRANS), 0);
	SendDlgItemMessage(hDlg, IDC_STARTMENUTRANSSPIN, UDM_SETRANGE,
		0, 100 << 16);
	...
	SendDlgItemMessage(hDlg, IDC_STARTMENUTRANSSPIN, UDM_SETPOS, 0, alpha);
...
void OnApply(HWND hDlg)
{
	...
	SetMyRegLong(m_section, "Alpha",
		SendDlgItemMessage(hDlg, IDC_STARTMENUTRANSSPIN, UDM_GETPOS, 0, 0));
}
